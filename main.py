...
app = Flask(__name__)  # تصحیح: استفاده از __name__ به جای _name
...
# راه‌اندازی ربات
if __name__ == "__main__":  # تصحیح: استفاده از __name__ به جای _name_
    ...
    print(f"🚀 ربات خدمات مهاجرت روی پорт {port} راه‌اندازی شد")
